...
def get_split_hexel_window(
    ...
    def trailing_padding(length: int, crop_size: int, stride: int) -> int:
        ...
        remainder = (length - crop_size) % stride
...
def main():
    ...
    parser.add_argument("--target_crop_h", type=int, default=None, help="Height of the centered supervised prediction crop.")
    parser.add_argument("--target_crop_w", type=int, default=None, help="Width of the centered supervised prediction crop.")
