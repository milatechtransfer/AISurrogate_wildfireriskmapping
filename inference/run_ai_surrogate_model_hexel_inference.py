...
def prepare_hexel_data(
    ...
    Args:
        ...
        target_crop_h: Height of the centered prediction tile.
        target_crop_w: Width of the centered prediction tile.
...
def run_single_hexel_pipeline(
    ...
    validate_context_crop_metadata(dataset.metadata, configured_target_crop(checkpoint["config"]))
